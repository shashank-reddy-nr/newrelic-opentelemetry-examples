...
/**
 * Kafka Producer — New Relic OpenTelemetry Example
 *
 * This is a standard Apache Kafka producer with zero OpenTelemetry SDK
 * dependencies. All observability — distributed traces, metrics, and W3C
 * Trace Context propagation into message headers — is handled automatically
 * by the OpenTelemetry Java Agent attached at runtime via -javaagent.
 *
...
public class ProducerApp {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        try (KafkaProducer<String, String> producer = new KafkaProducer<>(props)) {
            while (true) {
                // The OTel Java Agent intercepts each send() call and automatically:
                //   1. Creates a producer span
                //   2. Injects W3C Trace Context into the message headers
